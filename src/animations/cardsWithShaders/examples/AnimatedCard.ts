...
import { createSimpleFlipAnimation } from "../../cards/tweens/createSimpleFlipAnimation";


const ANIMATION_TIME = 800;
export class AnimatedCard extends BaseCardWithShaders {
    ...
    jump(time = ANIMATION_TIME, height = 40) {
        if (!this._canJump) {
            return;
        }
        this._canJump = false;
        this._jumpAnimation.animate(time / 2, height, () => {
            this._canJump = true;
        });
    }
