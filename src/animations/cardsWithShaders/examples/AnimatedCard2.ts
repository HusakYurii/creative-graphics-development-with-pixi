...
import { BaseCardWithShaders, type BaseCardWithShadersProps } from "../baseClasses/BaseCardWithShaders";
import type { BaseCardProps } from "../../cards/baseClasses/BaseCard";
import { createJumpAnimation } from "../../cards/tweens/createJumpAnimation";
import { createMoveAnimation } from "../../cards/tweens/createMoveAnimation";
import { createSGFlipAnimation } from "../../cards/tweens/createSGFlipAnimation";

const ANIMATION_TIME = 800;
export class AnimatedCard2 extends BaseCardWithShaders {
    ...
    constructor(props: BaseCardWithShadersProps) {
        super(props);
    ...
    jump(time = ANIMATION_TIME) {
        ...
        this._canJump = false;
        this._jumpAnimation.animate(time / 2, 40, () => {
            this._canJump = true;
        });
    }
