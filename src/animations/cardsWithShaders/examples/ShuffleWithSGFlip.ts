...
export class ShuffleWithSGFlip extends BaseCardsDeck<AnimatedCard2> {
    ...
    public stack(onFinish?: () => void): void {
        this._cards.forEach((card, i) => {
            card.view.position.set(0, -0.5 * i)
        });
        onFinish && onFinish();
    }
